...
If you find a security vulnerability in cluster_validator, please report it through [GitHub's private vulnerability reporting](https://github.com/florence-bockting/prevalidate/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact florence.bockting@aalto.fi for details.
